...
\todo[inline,color=green]{Gleiche Frage: Wie festhalten, dass das Frontend nicht weiter entwicklet wird? (Im Rahmen dieser Thesis).. Deshalb auch nur knappes Review des aktuellen Stands, da neues Prog-Sprache und Frameworks}
