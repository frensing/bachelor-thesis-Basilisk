...
The benchmarking process can be divided into two branches for the setup of \tsp{}.
\tsp{} from \dockh{} repositories are easier to setup than \tsp{} stored in \gh{} repositories.
For a benchmark of a \ts{} that is configured as a \dockh repository, the only task is to pull the docker image from \dockh{}.
