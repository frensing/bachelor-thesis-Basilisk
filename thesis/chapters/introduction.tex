...
In this thesis, we continue the development of the Basilisk\footnote{\url{https://github.com/dice-group/Basilisk}} platform and deploy an instance to a virtual machine.
